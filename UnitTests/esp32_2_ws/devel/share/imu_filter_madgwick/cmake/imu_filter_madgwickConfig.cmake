...
if("TRUE" STREQUAL "TRUE")
  set(imu_filter_madgwick_SOURCE_PREFIX /home/franco/IBTESIS/ibrover/UnitTests/esp32_2_ws/src/imu_tools/imu_filter_madgwick)
  set(imu_filter_madgwick_DEVEL_PREFIX /home/franco/IBTESIS/ibrover/UnitTests/esp32_2_ws/devel)
  ...
  set(imu_filter_madgwick_INSTALL_PREFIX /home/franco/IBTESIS/ibrover/UnitTests/esp32_2_ws/install)
...
if(NOT "/home/franco/IBTESIS/ibrover/UnitTests/esp32_2_ws/devel/include;/home/franco/IBTESIS/ibrover/UnitTests/esp32_2_ws/src/imu_tools/imu_filter_madgwick/include;/usr/include " STREQUAL " ")
  set(imu_filter_madgwick_INCLUDE_DIRS "")
  set(_include_dirs "/home/franco/IBTESIS/ibrover/UnitTests/esp32_2_ws/devel/include;/home/franco/IBTESIS/ibrover/UnitTests/esp32_2_ws/src/imu_tools/imu_filter_madgwick/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_filter_madgwick' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/franco/IBTESIS/ibrover/UnitTests/esp32_2_ws/src/imu_tools/imu_filter_madgwick/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/franco/IBTESIS/ibrover/UnitTests/esp32_2_ws/devel/lib;/opt/ros/melodic/lib)
