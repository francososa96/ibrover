...
if("TRUE" STREQUAL "TRUE")
  set(differential_drive_SOURCE_PREFIX /home/franco/IBTESIS/ibrover/UnitTests/simu1_ws/src/ibrover/differential_drive)
  set(differential_drive_DEVEL_PREFIX /home/franco/IBTESIS/ibrover/UnitTests/simu1_ws/devel)
  ...
  set(differential_drive_INSTALL_PREFIX /home/franco/IBTESIS/ibrover/UnitTests/simu1_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'imesh <imesh@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'differential_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/franco/IBTESIS/ibrover/UnitTests/simu1_ws/src/ibrover/differential_drive/${idir}'.  ${_report}")
    endif()
